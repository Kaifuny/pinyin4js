...
describe("# PinyinHelper", function() {
    describe("* convertToPinyinString(str, separator, format)", function() {
        ...
        it("PinyinHelper.convertToPinyinString('很好JavaScript很好', ' ', PinyinFormat.WITHOUT_TONE) = 'hen hao JavaScript hen hao'", function(){
            PinyinHelper.convertToPinyinString('很好JavaScript很好', ' ', PinyinFormat.WITHOUT_TONE).should.eql('hen hao JavaScript hen hao')
        })
    })
